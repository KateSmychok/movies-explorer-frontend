  ...
  return (
    <section id='student' className={styles.aboutMe}>
      ...
      <p className={styles.text}>
        Начала кодить в 2020 году, до этого был опыт работы в веб-студиях -
        занималась вёрсткой и контентом. Тогда и появился интерес к веб-разработке.
        Стала много читать про IT-технологии, потом пошла учиться в Яндекс.
        По образованию лингвист, переводчик. Знаю английский и немецкий языки.
        Увлекаюсь чтением книг, люблю мир Средиземья Толкина.
        Занимаюсь иногда спортом (плавание, велосипед, коньки).
